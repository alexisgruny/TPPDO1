...
include '../controller/controllerAddUser.php';
            ...
            <?php }else { ?>
                <form action="../view/addUser.php" method="POST">
                    <div class="form-group font-text font-weight-bold">
                        ...
                        <input class="form-control"  id="lastname" type="text" name="lastname" value="<?= isset($modifyUser->lastname) ? $modifyUser->lastname : '' ?>" />
                        <p class="text-danger"><?= isset($formError['lastname']) ? $formError['lastname'] : ''; ?></p>
                        <label for="firstname">Prénom</label>
                        <input class="form-control" id="firstname" type="text" name="firstname" value="<?= isset($modifyUser->firstname) ? $modifyUser->firstname : '' ?>" />
                        <p class="text-danger"><?= isset($formError['firstname']) ? $formError['firstname'] : ''; ?></p>
                        <label for="birthDate">Date de naissance</label>
                        <input type="date" class="form-control" id="birthDate" name="birthDate" value="<?= isset($modifyUser->birthDate) ? $modifyUser->birthDate : '' ?>" />
                        <p class="text-danger"><?= isset($formError['birthDate']) ? $formError['birthDate'] : ''; ?></p>
                        <label for="adress">Adresse</label>
                        <input class="form-control" id="adress" type="text" name="adress" value="<?= isset($modifyUser->adress) ? $modifyUser->adress : '' ?>" />
                        <p class="text-danger"><?= isset($formError['adress']) ? $formError['adress'] : ''; ?></p>
                        <label for="postalCode">Code postal</label>
                        <input class="form-control" id="postalCode" type="text" name="postalCode" value="<?= isset($modifyUser->postalCode) ? $modifyUser->postalCode : '' ?>" />
                        <p class="text-danger"><?= isset($formError['postalCode']) ? $formError['postalCode'] : ''; ?></p>
                        <label for="phone">Téléphone</label>
                        <input class="form-control" id="phone" name="phone" value="<?= isset($modifyUser->phone) ? $modifyUser->phone : '' ?>" />
